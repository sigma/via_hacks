  ...
  new:: function(via) keyboard(via) + {
    ...
    default_mac_layer:: function()
      ...
      self.default_win_layer().override({
        [R.funcs]: [null, 'KC_BRID', 'KC_BRIU', MC, LP, 'RGB_VAD', 'RGB_VAI', 'KC_MPRV', 'KC_MPLY', 'KC_MNXT', 'KC_MUTE', 'KC_VOLD', 'KC_VOLU', SS, SI],
        [R.mods]: [null, LO, LC, null, RC, RO, 'MO(%d)' % L.fn_mac],
      }),
    ...
    default_win_layer:: function()
      ...
      via.layer([
        ...
        ['KC_LCTL', 'KC_LGUI', 'KC_LALT', 'KC_SPC', 'KC_RALT', 'KC_RGUI', 'MO(%d)' % self.layer_idx.fn_win, 'KC_RCTL', 'KC_LEFT', 'KC_DOWN', 'KC_RGHT'],
      ]),
